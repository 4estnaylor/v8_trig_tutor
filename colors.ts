...
const purple = { hue: 238, saturation: 89, lightness: 60 };
const purple_light = { hue: 225, saturation: 72, lightness: 80 };
const purple_dark = { hue: 225, saturation: 72, lightness: 30 };
const mint = { hue: 163, saturation: 90, lightness: 48 };
