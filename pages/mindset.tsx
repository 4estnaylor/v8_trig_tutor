    ...
    <TopicComponentBoilerPlate2 title="mindset">
      <>
        <WrapperPadding5>
          ...
          Problem is, hyper focusing on grades, while it can work, tends to be
          one of the more inefficient, joyless ways to get a good grade.
          <br />
          <br />
          ...
          that a trig class has to offer. Prioritizing your grade above actually
          getting good at trig is putting the cart before the horse and often
          ends up making things even more difficult and stressful than they need
          to be.
          <br />
          <br />
          ...
          who persue it. Students that focus on understanding over GPA in the
          long run get even higher grades as a side-effect along with a much
...
const WrapperPadding5 = styled.div`
  padding: 5px;
`;
